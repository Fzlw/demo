 ...
 * @param notify_url 设置回调地址
 * 密钥需要命名成open_rsa_private_key.pem与open_rsa_public_key.pem
 */
AlipayAPI.request = function (appid, method, biz_content,notify_url) {
    ...
    if(notify_url != null && notify_url != undefined){
      alipayRequest.setParam('notify_url', notify_url);
    }
    //这个必须是最后一个参数
